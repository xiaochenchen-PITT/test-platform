...
public class MigrationCheckService {
    ...
    public DiffResult compare(Long batchId, MigrationConfig migrationConfig, MigrationCheckConfig migrationCheckConfig, String triggerUrl) {
        ...
        try {
            ...
            List<MigrationData> sourceDataList = initSourceFullData(migrationConfig, sourceDataSource);
...
//                    log.info("adding one....");
    ...
    private List<MigrationData> initSourceFullData(MigrationConfig migrationConfig, DataSource sourceDataSource) {
